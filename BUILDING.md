...
ensure all CMake builds use the same C++ standard (at least C++20).
This is crucial because gRPC C++ 1.70 and later require at least C++20, and Abseil, a gRPC dependency,
